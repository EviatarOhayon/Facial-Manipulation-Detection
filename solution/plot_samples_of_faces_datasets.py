...
def main():
    ...
    #print('fakes_dataset_train : real_image_idx = ', real_image_idx, ', fake_image_idx = ', fake_image_idx)
    ...
    #print('synthetic_dataset_train : real_image_len = ', real_image_idx, ', fake_image_idx = ', fake_image_idx)
    print()
